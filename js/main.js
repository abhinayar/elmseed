...
dp(document).ready(function() {
    dp("#about-us-mission-slider").delay(5000).show("slide", { direction: "right" }, 1200);
    ...
    dp(".main-services-carousel-nav-item").click(function(){
        dp('.active-nav-item').removeClass('active-nav-item');
        dp(this).addClass('active-nav-item')
    });
